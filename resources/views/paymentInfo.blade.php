<html>
    <head>
    <title>Payment Information Guide - Get Your Tour Guide Uae</title>
    </head>
</html>
<x-app-layout>
    <x-slot name="header">
            ...
            <x-guest-layout>
                <form method="POST" action="paymentInfo">
                    ...
                    <div>
                        ...
                        <x-text-input id="appname" class="block mt-1 w-full text-black bg-white" type="text" name="appname" :value="old('appname')" required autofocus autocomplete="App Name/ Bank Name" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="accountname" class="block mt-1 w-full text-black bg-white" type="text" name="accountname" :value="old('accountname')" required autocomplete="Name on Account" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="accountnumber" class="block mt-1 w-full text-black bg-white" type="text" name="accountnumber" :value="old('accountnumber')" required autocomplete="accountnumber" />
                        <x-input-error :messages="$errors->get('accountnumber')" class="mt-2 text-black bg-white" />
                    </div>

                    <!-- cnic -->
                    <div class="mt-4">
                        <x-input-label for="paymentmethod" :value="__('Payment method')" class="text-black bg-white"/>
                        <x-text-input id="paymentmethod" class="block mt-1 w-full text-black bg-white" type="text" name="paymentmethod" :value="old('paymentmethod')" required autocomplete="Payment method" />
                        <x-input-error :messages="$errors->get('paymentmethod')" class="mt-2 text-black bg-white" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="accountlimit" :value="__('Account Limit')" class=""/>
                        <x-text-input id="accountlimit" class="block mt-1 w-full text-black bg-white" type="text" name="accountlimit" :value="old('accountlimit')" required autocomplete="Account Limit" />
