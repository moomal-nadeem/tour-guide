<html>
    <head>
    <title>Update Address Information Guide - Get Your Tour Guide Uae</title>
    </head>
</html>
<x-app-layout>
    <x-slot name="header">
    ...
    <div>
        <div>
            <x-guest-layout>
                <form method="POST" action="addressInfoEdit">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="city" class="block mt-1 w-full text-black bg-white" type="text" name="city" :value="$data['city']" required autofocus autocomplete="City" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="code" class="block mt-1 w-full text-black bg-white" type="text" name="code" :value="$data['code']" required autocomplete="Area Code" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="country" class="block mt-1 w-full text-black bg-white" type="text" name="country" :value="$data['country']" required autocomplete="Country" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="address" class="block mt-1 w-full" text-black bg-white type="text" name="address" :value="$data['address']" required autocomplete="Address" />
