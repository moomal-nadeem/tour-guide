...
<head>
    ...
    <title>Invoice - Get Your Tour Guide Uae</title>
    <style>
        body {
...
<body>
    <div class="invoice-container">
        ...
        <div class="bill-details">
            ...
            <div class="text-gray-700 mb-3 mt-3">{{$deal->email}}</div>

            <h3>Guide Info:</h3>
            <div class="text-gray-700 mb-1">{{$usrData->name}}</div>
            <div class="text-gray-700 mb-1">{{$usrData->pno}}</div>
            <div class="text-gray-700 mb-3 mt-3">{{$usrData->email}}</div>
            <table class="w-full mb-3 mt-3">
            ...
            <div class="booked-dates mt-2"><b>Booked Dates :</b> {{$deal->dated}}</div>
