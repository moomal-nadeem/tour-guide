<p class="m-5 lg:ml-[3rem]">Accounts</p>
...
<div class="block m-2  w-[20rem] lg:w-[15rem] xl:w-[15rem] md:w-[15rem]  rounded-lg bg-white shadow-[0 2px 15px -3px rgba(0, 0, 0, 0.07), 0 10px 20px -2px rgba(0, 0, 0, 0.04)] dark:bg-neutral-700">
  <div class="p-6 text-center">
    <div class="flex justify-center items-center mb-4">
      <div class="h-12 w-12 bg-[#FF9119] text-[#4169e1] rounded-full flex items-center justify-center text-white font-bold text-lg">L</div>
    </div>
    <h5 class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
    20400
    </h5>
    <p class="text-[#b0c4de]">Liabilities</p>
  </div>
</div>
...
<div class="block m-2  w-[20rem] lg:w-[15rem] xl:w-[15rem] md:w-[15rem]  rounded-lg bg-white shadow-[0 2px 15px -3px rgba(0, 0, 0, 0.07), 0 10px 20px -2px rgba(0, 0, 0, 0.04)] dark:bg-neutral-700">
  <div class="p-6 text-center">
    <div class="flex justify-center items-center mb-4">
      <div class="h-12 w-12 bg-[#FF9119] text-[#4169e1] rounded-full flex items-center justify-center text-white font-bold text-lg">E</div>
    </div>

    <h5 class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
    3034 AED 
    </h5>
    <p class="text-[#b0c4de]">Expense</p>
  </div>
</div>
