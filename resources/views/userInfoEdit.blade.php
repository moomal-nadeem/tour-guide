<html>
    <head>
    <title>Update Profile Information Guide - Get Your Tour Guide Uae</title>
    </head>
</html>
<x-app-layout>
    <x-slot name="header">
            ...
            <x-guest-layout>
                <form action="userInfoEdit" method="post">
                    ...
                    <div>
                        ...
                        <x-text-input id="language" class="block mt-1 w-full text-black bg-white" type="text" name="language" :value="$data['language']" required autofocus autocomplete="Language" placeholder="English, Arabic, Urdu, Hindi" />
